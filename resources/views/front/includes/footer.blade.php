...
<div class="footer">
	<div class="container">
		...
		<div class="container">
				...
				<div class="clearfix"> </div>
				<p class="footer-class animated wow fadeInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;"> © 2016 Youth Fashion . All Rights Reserved | Design by <a href="http://kreativedesignagency.com/" target="_blank">KDA</a> </p>
			</div>
	</div>
</div>
<!--footer-->